...
def load_data():
   with st.spinner(text="Loading and indexing the Documents – hang tight! This should take 1-2 minutes."):
       ...
       llm = Gemini(api_key='AIzaSyCabUkkwlETgphIJkqqA1095Z1an5tgVI4')
       embed_model = GeminiEmbedding(api_key='AIzaSyCabUkkwlETgphIJkqqA1095Z1an5tgVI4')  # Fix typo
...
if "chat_engine" not in st.session_state.keys():
   ...
   llm = ChatGoogleGenerativeAI(model="gemini-pro", google_api_key='AIzaSyCabUkkwlETgphIJkqqA1095Z1an5tgVI4', temperature=0.1)
